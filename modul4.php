...
<body>
    ...
    <form method="post" action="">
        ...
        <input type="number" id="hrgBarang" name="hrgBarang" required><br>
    ...
    <?php if ($edit_barang): ?>
        ...
        <form method="post" action="">
            ...
            <label for="hrgBarang">Harga Barang</label><br>
            <input type="number" id="hrgBarang" name="hrgBarang" required value="<?php echo $edit_barang['harga']; ?>"><br>

            <label for="stok">Stok Barang</label><br>
            <input type="number" id="stok" name="stok" required value="<?php echo $edit_barang['stok']; ?>"><br><br>
